...
try:
   ...
   for i in response['result']:
       tup = (index , i['name'] , i['usrgrpid'] , i['users_status'] , _time , jifang , i['gui_access'] , i['debug_mode'])
       print tup
       print i['usrgrpid'] + ' : ' + i['name']
       try:
           ...
           sql = "insert into zabbix_usergroup values(%s , %s , %s , %s ,%s , %s ,%s , %s)"

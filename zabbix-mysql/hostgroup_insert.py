...
data = json.dumps(
{
    ...
    "auth": "944403ac5983b711ef785eb2cd24324f",
    "id": 1
})
...
try:
   ...
   for host in response['result']:
       ...
       hosts = ''
       for ht in host['hosts']:
           hosts = hosts + ht['name'] + ','

       print host['name'] , host['groupid']
       print templates
       print hosts
       print '======================='
   ...
   #
       try:
           ...
           tup = (index , host['name'] , _time , jifang , host['groupid'] , templates , hosts) #fixme id可以随便设一个值
           value_List.append(tup)
           sql = "insert into zabbix_hostgroup values(%s , %s , %s ,%s , %s ,%s , %s)"
